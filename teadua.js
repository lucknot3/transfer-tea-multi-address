...
if (!RPC_URL || !process.env.PRIVATE_KEY_1 || !process.env.PRIVATE_KEY_2 || !process.env.TOKEN_ADDRESS_1 || !process.env.TOKEN_ADDRESS_2) {
    console.error("❌ ERROR: Pastikan file .env dikonfigurasi dengan benar untuk 2 wallet.");
    process.exit(1);
}
